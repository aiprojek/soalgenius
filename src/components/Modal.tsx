...
export default function Modal({ isOpen, onClose, title, children, size = 'lg' }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-end sm:items-center sm:p-4" onClick={onClose}>
      <div className={`bg-white shadow-xl w-full ${sizeClasses[size]} flex flex-col h-full rounded-t-lg sm:rounded-lg sm:h-auto sm:max-h-[90vh]`} onClick={(e) => e.stopPropagation()}>
