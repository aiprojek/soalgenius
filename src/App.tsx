        ...
        <div className="bg-gray-100 min-h-screen font-sans">
            ...
            <Modal isOpen={isInfoModalOpen} onClose={() => setInfoModalOpen(false)} title="Tentang & Panduan SoalGenius" size="3xl">
                <div className="space-y-6 text-gray-700 text-sm">
                    ...
                    <div className="space-y-4">
                        <GuideSection title="1. Memulai Ujian Baru" icon={<PlusIcon className="w-5 h-5 text-blue-600" />}><ul className="list-disc list-outside space-y-1"><li>Dari halaman utama (Arsip), klik tombol <strong>plus (+) melayang</strong> di pojok kanan bawah.</li><li>Isi informasi dasar ujian seperti <strong>Judul, Mata Pelajaran, Kelas,</strong> dan <strong>Waktu</strong> pengerjaan.</li><li>Anda bisa menambahkan <strong>deskripsi</strong> internal (tidak akan dicetak) sebagai catatan.</li></ul></GuideSection>
                        <GuideSection title="2. Editor Soal" icon={<EditorIcon className="w-5 h-5 text-blue-600" />}><ul className="list-disc list-outside space-y-1"><li><strong>Bagian Soal:</strong> Ujian dapat dibagi menjadi beberapa bagian. Gunakan tombol <strong>"Tambah Bagian Soal Baru"</strong> untuk memisahkan tipe soal.</li><li><strong>Editor Teks:</strong> Gunakan toolbar di atas setiap kotak teks untuk format <strong>bold</strong>, <i>italic</i>, <u>underline</u>, warna, dan perataan teks.</li><li><strong>Menyusun Ulang:</strong> Tahan dan seret ikon titik-titik ( <DragHandleIcon className="w-4 h-4 inline-block -mt-1"/> ) di samping soal atau bagian untuk mengubah urutannya.</li></ul></GuideSection>
                        <GuideSection title="3. Bank Soal" icon={<BankIcon className="w-5 h-5 text-blue-600" />}><ul className="list-disc list-outside space-y-1"><li><strong>Menyimpan:</strong> Di setiap soal pada editor, klik ikon <BookmarkIcon className="w-4 h-4 inline-block -mt-1"/> untuk menyimpannya ke Bank Soal.</li><li><strong>Menggunakan:</strong> Klik tombol <strong>"Dari Bank Soal"</strong> di editor untuk membuka koleksi soal Anda.</li><li><strong>Mengelola:</strong> Buka halaman <strong>Bank Soal</strong> dari navigasi bawah untuk memfilter, mencari, dan mengedit soal Anda.</li></ul></GuideSection>
                        <GuideSection title="4. Pratinjau, Cetak & Ekspor" icon={<PrintIcon className="w-5 h-5 text-blue-600" />}><ul className="list-disc list-outside space-y-1"><li>Klik tombol <strong>"Pratinjau"</strong> untuk melihat tampilan dokumen sebelum dicetak.</li><li>Gunakan tombol <ShareIcon className="w-4 h-4 inline-block -mt-1"/> untuk <strong>Mencetak ke PDF</strong> atau <strong>Mengekspor ke HTML</strong>.</li><li>Klik ikon gerigi (<SettingsIcon className="w-4 h-4 inline-block -mt-1"/>) dari menu utama untuk mengatur <strong>kop surat,</strong> ukuran kertas, dan margin.</li></ul></GuideSection>
                        <GuideSection title="5. Manajemen Data (PENTING)" icon={<DownloadIcon className="w-5 h-5 text-blue-600" />}><ul className="list-disc list-outside space-y-1"><li><strong>Cadangkan:</strong> Secara berkala, buka menu utama (ikon titik tiga) dan pilih <strong>"Cadangkan Data"</strong> untuk mengunduh semua data Anda.</li><li><strong>Pulihkan:</strong> Untuk memulihkan data, pilih <strong>"Pulihkan Data"</strong> dari menu yang sama.</li></ul></GuideSection>
                    </div>
